"""Finance domain glossary — canonical definitions and formulas.

In a production system this would live in a vector store and be retrieved via
RAG. For the prototype it is a plain dict: every term has a definition, a
formula (where applicable), and a list of account categories it touches.
"""
